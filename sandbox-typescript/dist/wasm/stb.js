var STBModule = (() => {
    ...
    return (function (STBModule) {
        STBModule = STBModule || {};
        var Module = typeof STBModule != "undefined" ? STBModule : {};
        ...
        if (Module["locateFile"]) {
            ...
            wasmBinaryFile = new URL("stb.wasm", import.meta.url).toString();
        }
        ...
        if (Module["noInitialRun"])
            shouldRunNow = false;
        run();
        return STBModule.ready;
    });
})();
export default STBModule;
